...
NCS With Random OTP And Recurring Payments
    ...
    Log To Console    vps_request_payment_transaction_id=${vps_request_payment_transaction_id}
...
Add New Recurring Payment Method
    ...
    #Set Suite Variable   ${billing_account_id}  5000044385
    #Set Suite Variable  ${VPS_RECURRING_PAYMENT_METHOD}  Visa
    #Set Suite Variable   ${customer_ref}   e36db2df-55aa-413a-a0cc-126f18d3c315
    Sleep   10s
