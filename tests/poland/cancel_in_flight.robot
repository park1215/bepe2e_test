...
Add Selected Plan To Cart And validate OFM
    ...
    #${discount_spb_price_category}    ${contract_spb_price_category_duration}    Get SPB Category For Child Product    ${cart_id}    ${DISCOUNT_KIND}
    #Set Test Variable    ${discount_spb_price_category}
    #Log    ${discount_spb_price_category}, ${contract_spb_price_category_duration}
