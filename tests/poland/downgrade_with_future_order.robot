...
NCS And SISA With Sat 50
    ...
    Set Test Variable    ${offer_id}    3e5c82a3-7432-406d-bc12-643d22ce4be9
    Set Test Variable    ${offer_name}    Sat 50
...
Downgrade To Sat 5 With Existing Customer With Future Order
    ...
    Set Test Variable    ${offer_id}    e9fac3ba-535d-4cf4-b371-181050b0d57b
    Set Test Variable    ${offer_name}    Sat 5
...
Validate New Downgraded Plan Is Processed But Not Activated
    ...
    ${nc_ids}   Run Keyword  Get Product Id And Tariff Id For Generic Main Product  ${new_offer_name}
    Log    ${nc_ids}

    #  ${nc_ids}  has product_id and tariff_id, ${spb_price_dict} has xxx_spb_price_category, KIND variables are in country_variables
    ${product_pid_mapping}   Create Generic PID Mapping For Main And Subproducts  ${existing_customer_billing_account_id}  ${subscription_id}  ${nc_customer_ref}   ${product_instance_id}
    ...   ${high_level_spb_category}  ${nc_ids}   ${spb_price_dict}
