...
Cancel In Flight For Different Order
    ...
    Refund Payment And Verify NC Update   ${payment_transaction_id}   ${advance_payment} 
    ${refund_amount}   Evaluate  -1* ${advance_payment}
    Get PR Mandate Presence and RB Payment Method Id   ${billing_account_id}   
    Wait Until Keyword Succeeds  3x  5s   Verify SPB Account Payment History   ${billing_account_id}  ${refund_amount}   ${VPS_PAYMENT_METHOD}
