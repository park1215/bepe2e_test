...
OFM Negative Tests
    ...
    Run Keyword And Continue On Failure    Verify Get Offer Fails For Not Supported Country     ${buyer_id}    ${SELLER_ID}    CN .   {'latitude': 39.9042, 'longitude': 116.4074}
