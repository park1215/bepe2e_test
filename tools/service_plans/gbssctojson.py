...
business_plans_json = _readServiceIds("gbs_business_plans.json")
business_plans_gbs = business_plans_json["GBS"]["AB"]
business_plans_gbs.extend(business_plans_json["GBS"]["SB2"])
...
for package in catalog_json['packages']:
    if package['catalogId'] in business_plans_gbs:
        service_flow_ids = []
...
f = open("gbs_service_catalog.json","w")
